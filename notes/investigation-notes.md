# Investigation Notes — Sentinel Lab 06

## Investigation Overview

**Investigation Type:** Account Compromise Investigation  
**Platform:** Microsoft Sentinel  
**Data Source:** Synthetic KQL `datatable()`  
**Primary Account:** `user1@sentinellab.local`  
...
Does the authentication history and subsequent endpoint activity provide sufficient evidence to suspect that `user1@sentinellab.local` may have been compromised?
...
A production investigation should examine:

1. MFA results.
2. Conditional Access results.
3. Authentication method.
4. Sign-in risk.
5. Device identity and compliance.
6. PowerShell Script Block Logging.
7. Process creation and child processes.
8. Network connections.
9. File creation and modification.
10. Endpoint security alerts.
11. The decoded PowerShell command.
12. User confirmation of the suspicious authentication.

---

## Key Lesson

A possible account compromise becomes easier to assess when identity and endpoint activity are connected through:

**User + Computer + Source + Time + Process Context**

The analyst should build the evidence chain first and only then determine the strength of the compromise hypothesis.
